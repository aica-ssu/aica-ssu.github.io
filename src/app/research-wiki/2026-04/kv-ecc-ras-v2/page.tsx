...
export const metadata: Metadata = {
  title: "KV Cache ECC + RAS v2 (Landing) - AICA Lab",
  robots: { index: false, follow: false },
};

const ROUTE_BASE = "/research-wiki/2026-04/kv-ecc-ras-v2";

export default async function KvEccRasV2LandingPage() {
  const filePath = path.join(
    process.cwd(),
    "src/data/docs/research-wiki/2026-04-kv-ecc-ras-v2/README.md"
  );
