...
export const metadata: Metadata = {
  title: "Unselected — MoE Fingerprint Security + Serving - AICA Lab",
  robots: { index: false, follow: false },
};

const ROUTE_BASE_DIR = "/research-wiki/2026-04/moe-fingerprint-security-serving";
...
export default async function UnselectedPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      >
        ← MoE Fingerprint Security + Serving (Landing)
      </Link>
