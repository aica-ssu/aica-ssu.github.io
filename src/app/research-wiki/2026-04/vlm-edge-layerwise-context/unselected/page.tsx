...
export const metadata: Metadata = {
  title: "Unselected — VLM Edge Layer-Wise + Context-Semantic - AICA Lab",
  robots: { index: false, follow: false },
};

const ROUTE_BASE_DIR = "/research-wiki/2026-04/vlm-edge-layerwise-context";

export default async function UnselectedPage() {
  const filePath = path.join(
    process.cwd(),
    "src/data/docs/research-wiki/2026-04-vlm-edge-layerwise-context/unselected.md"
  );
