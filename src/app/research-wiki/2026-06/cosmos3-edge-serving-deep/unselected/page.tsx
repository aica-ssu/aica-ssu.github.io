...
export const metadata: Metadata = {
  title: "Unselected — Cosmos3 MoT Edge Serving (Deep) - AICA Lab",
  robots: { index: false, follow: false },
};

const ROUTE_BASE_DIR = "/research-wiki/2026-06/cosmos3-edge-serving-deep";

export default async function UnselectedPage() {
  const filePath = path.join(
    process.cwd(),
    "src/data/docs/research-wiki/2026-06-cosmos3-edge-serving-deep/unselected.md"
  );
