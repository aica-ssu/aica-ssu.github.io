...
export const metadata: Metadata = {
  title: "Unselected — Edge Multi-Agent Hybrid-SSM/MoE Serving - AICA Lab",
  robots: { index: false, follow: false },
};

const ROUTE_BASE_DIR = "/research-wiki/2026-06/nemotron3-edge-agentic-serving";

export default async function UnselectedPage() {
  const filePath = path.join(
    process.cwd(),
    "src/data/docs/research-wiki/2026-06-nemotron3-edge-agentic-serving/unselected.md"
  );
