...
export const metadata: Metadata = {
  title: "Tier-2 Idea — Edge Multi-Agent Hybrid-SSM/MoE Serving - AICA Lab",
  robots: { index: false, follow: false },
};

const ROUTE_BASE_DIR = "/research-wiki/2026-06/nemotron3-edge-agentic-serving/tier2";
...
export default async function Tier2IdeaPage({ params }: { params: Promise<{ idea: string }> }) {
  ...
  const filePath = path.join(
    process.cwd(),
    `src/data/docs/research-wiki/2026-06-nemotron3-edge-agentic-serving/tier2/${idea}.md`
  );
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      >
        ← Edge Multi-Agent Hybrid-SSM/MoE Serving (Landing)
      </Link>
