...
export const metadata: Metadata = {
  title: "Unselected — VLM Edge Multi-Turn / Multi-Focus Serving - AICA Lab",
  robots: { index: false, follow: false },
};

const ROUTE_BASE_DIR = "/research-wiki/2026-06/vlm-edge-multiturn";

export default async function UnselectedPage() {
  const filePath = path.join(
    process.cwd(),
    "src/data/docs/research-wiki/2026-06-vlm-edge-multiturn/unselected.md"
  );
