...
export const metadata: Metadata = {
  title: "Tier-1 Idea — Cosmos3 MoT Edge Serving (Superseded) - AICA Lab",
  robots: { index: false, follow: false },
};

const ROUTE_BASE_DIR = "/research-wiki/2026-06/cosmos3-mot-edge-serving/tier1";
...
export default async function Tier1IdeaPage({ params }: { params: Promise<{ idea: string }> }) {
  ...
  const filePath = path.join(
    process.cwd(),
    `src/data/docs/research-wiki/2026-06-cosmos3-mot-edge-serving/tier1/${idea}.md`
  );
