...
export const metadata: Metadata = {
  title: "Unselected — VLM SpecDec + Chunked Prefill Optimization - AICA Lab",
  robots: { index: false, follow: false },
};

const ROUTE_BASE_DIR = "/research-wiki/2026-05/vlm-specdec-chunked-prefill";

export default async function UnselectedPage() {
  const filePath = path.join(
    process.cwd(),
    "src/data/docs/research-wiki/2026-05-vlm-specdec-chunked-prefill/unselected.md"
  );
