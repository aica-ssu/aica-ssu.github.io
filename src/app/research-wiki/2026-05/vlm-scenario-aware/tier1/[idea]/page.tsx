...
export const metadata: Metadata = {
  title: "Tier-1 Idea — VLM Scenario-Aware Optimization - AICA Lab",
  robots: { index: false, follow: false },
};

const ROUTE_BASE_DIR = "/research-wiki/2026-05/vlm-scenario-aware/tier1";
...
export default async function Tier1IdeaPage({ params }: { params: Promise<{ idea: string }> }) {
  ...
  const filePath = path.join(
    process.cwd(),
    `src/data/docs/research-wiki/2026-05-vlm-scenario-aware/tier1/${idea}.md`
  );
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      >
        ← VLM Scenario-Aware Optimization (Landing)
      </Link>
