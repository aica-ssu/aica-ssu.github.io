...
export const metadata: Metadata = {
  title: "Tier-1 Idea — AI Memory Error Mitigation & Page Migration - AICA Lab",
  robots: { index: false, follow: false },
};

const ROUTE_BASE_DIR = "/research-wiki/2026-05/ai-memory-error-mitigation/tier1";
...
export default async function Tier1IdeaPage({ params }: { params: Promise<{ idea: string }> }) {
  ...
  const filePath = path.join(
    process.cwd(),
    `src/data/docs/research-wiki/2026-05-ai-memory-error-mitigation/tier1/${idea}.md`
  );
