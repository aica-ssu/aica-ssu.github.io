...
export const metadata: Metadata = {
  title: "Tier-2 Idea — AI Memory Error Mitigation & Page Migration - AICA Lab",
  robots: { index: false, follow: false },
};

const ROUTE_BASE_DIR = "/research-wiki/2026-05/ai-memory-error-mitigation/tier2";
...
export default async function Tier2IdeaPage({ params }: { params: Promise<{ idea: string }> }) {
  ...
  const filePath = path.join(
    process.cwd(),
    `src/data/docs/research-wiki/2026-05-ai-memory-error-mitigation/tier2/${idea}.md`
  );
