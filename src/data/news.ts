...
export const news: NewsItem[] = [
  ...
  { date: "2024.07", content: "ZEC ECC paper published in IEEE Access", contentKo: "ZEC ECC 논문이 IEEE Access에 게재되었습니다." },
  { date: "2024.03", content: "Paper accepted to HPCA 2024 (Bandwidth-Effective DRAM Cache for GPUs)", contentKo: "HPCA 2024에 논문이 채택되었습니다." },
