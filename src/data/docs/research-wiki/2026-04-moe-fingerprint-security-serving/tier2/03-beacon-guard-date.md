...
> [← Session Overview](../README.md) · **Tier-2 독립 #3** (Tier-1 ATC fallback)
...
BEACON-GUARD Tier-1 ATC ([../tier1/03-beacon-guard.md](../tier1/03-beacon-guard.md)) 의 **Mech 2 (Multi-Signal Fingerprint Fusion Geometric Analysis) 단독 축소**. ATC 12p 에서 LOOM' 와 paper-pair 진행이 어려운 경우 DATE 6p deployment cost 차트 중심 fallback.
...
→ Tier-1 [03-beacon-guard.md](../tier1/03-beacon-guard.md) 참조.
