...
> [← Session Overview](../README.md) · **Tier-2 독립 #1**
...
DISCRETE-VEIL Tier-1 [01-discrete-veil.md](../tier1/01-discrete-veil.md) 의 §2 와 동일하지만, scope 축소로 V-MoE PGD baseline + GateBreaker 비교는 1-2 줄 brief reference 만:
...
→ Tier-1 [01-discrete-veil.md](../tier1/01-discrete-veil.md) 참조.
