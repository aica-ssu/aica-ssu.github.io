    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "🥈 Bivouac (NeurIPS 2026)", href: "/research-wiki/2026-04/vlm-edge-layerwise-context/tier1/02-bivouac" },
          { label: "🥉 RadixVL (OSDI 2026, W12 분기)", href: "/research-wiki/2026-04/vlm-edge-layerwise-context/tier1/03-radixvl" },
          { label: "4️⃣ Atrium (HPCA 2027, retain)", href: "/research-wiki/2026-04/vlm-edge-layerwise-context/tier1/04-atrium" },
          { label: "T1 Strata (DAC 2027)", href: "/research-wiki/2026-04/vlm-edge-layerwise-context/tier2/01-strata" },
          { label: "T2 Harbinger (ISLPED 2027)", href: "/research-wiki/2026-04/vlm-edge-layerwise-context/tier2/02-harbinger" },
          { label: "T3 Obelisk (MLSys 2027)", href: "/research-wiki/2026-04/vlm-edge-layerwise-context/tier2/03-obelisk" },
